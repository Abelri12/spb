        ...
        <div class="col-md-12">
          <div class="panel form-element-padding">
            <div class="panel-heading">
             <h4>Basic Element bu  <a href="{{url('spb')}}" class="btn btn-primary pull-right">Kembali</a></h4>
             ...
             <div class="panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
                {{--awal form  --}}
                <form class="form-horizontal" action="{{ url ('update',$list->id_item)}}" method="post">
                  ...
                  <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-right">Nama Barang/Jasa</label>
                          ...
                          <div class="col-sm-10"><input type="text" class="form-control primary" name="nama_barang" placeholder="Nama Barang Atau Jasa" value="{{$list->nm_item}}"></div>
                    </div>
                      ...
                      <div class="form-group">
                          <label class="col-sm-2 control-label text-right">Unit Satuan</label>
                            <div class="col-sm-10"><input type="text" class="form-control primary" name="satuan" placeholder="isi jumlah atau satuan" value="{{$list->unit_satuan}}"></div>
                      </div>
                      <div class="form-group">
                          <label class="col-sm-2 control-label text-right">Harga</label>
                            <div class="col-sm-10"><input type="text" class="form-control primary" name="harga" placeholder="Masukan Harga" value="{{$list->item_harga}}" ></div>
                      </div>

                      {{-- <div class="form-group">
                          <label class="col-sm-2 control-label text-right">Tanggal</label>
                          @foreach ($tampiljenispermintaan as $jenis)
                            <div class="col-sm-10"><input type="text" name="tanggal" id="tanggal" class="form-control primary" placeholder="Masukan Tanggal Pembuatan" value ="{{$jenis->create_at}}"></div>
                          @endforeach

                      </div> --}}
                      <div class="form-group">
                          <label class="col-sm-2 control-label text-right">Keterangan</label>
                            <div class="col-sm-10"><textarea class="form-control primary" name="keterangan" rows="8" cols="40" placeholder="Masukan Komentar" value = "">{{$list->keterangan}}</textarea></div>
                     </div>
                     <br>
